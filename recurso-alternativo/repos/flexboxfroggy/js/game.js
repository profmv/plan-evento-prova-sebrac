var game = {
  ...
  language: window.location.hash.substring(1) || 'pt-br',
  difficulty: 'easy',
  ...
  win: function() {
    ...
    if (window.MinigameBridge) {
      window.MinigameBridge.completeGame('flexboxfroggy', {
        score: 100,
        details: 'Completou todas as fases do Flexbox Froggy com sucesso'
      });
    }
  },

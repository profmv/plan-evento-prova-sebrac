var messages = {
  ...
  title: {
    ...
    'hy': 'Grid Garden - Խաղ CSS grid սովորելու համար',
  ...
  warningReset: {
    ...
    'hy': 'Համոզվա՞ծ եք, որ ցանկանում եք վերսկսել խաղը:\n\nՁեր պահպանված արդյունքները կջնջվեն, և դուք կվերադառնաք խաղի սկիզբ:',
  ...
  warningUnsupported: {
    ...
    'hy': '<p>Օյ, ոչ, Grid Garden-ը չի աշխատում այս բրաուզերում: Այն պահանջում է <a href="https://caniuse.com/#feat=css-grid">CSS grid-ին աջակցող բրաուզեր</a>, ինչպիսիք են <a href="https://www.mozilla.org/firefox/">Firefox</a>-ի, <a href="https://www.google.com/chrome/">Chrome</a>-ի կամ <a href="https://www.apple.com/safari/">Safari</a>-ի վերջին տարբերակները: Օգտագործեք դրանցից մեկը՝ այգեպանությունն սկսելու համար:</p>',
  ...
  flexboxFroggy: {
    ...
    'hy': 'Ցանկանո՞ւմ եք ավելին սովորել CSS-ից: Խաղացեք',
